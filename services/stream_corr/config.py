...
class StreamCorrSettings:
    ...
    def load(cls) -> "StreamCorrSettings":
        return cls(
            ...
            group_name=os.getenv("SIEM_STREAM_CORR_GROUP", "stream_corr"),
            consumer_name=os.getenv("SIEM_STREAM_CORR_CONSUMER", "stream-corr-1"),
            batch_size=int(os.getenv("SIEM_STREAM_CORR_BATCH_SIZE", "100")),
        )
