...
TARGETS: tuple[RuntimeTarget, ...] = (
    ...
    RuntimeTarget(126, "qemu", "openclaw-gateway", "edge-gateway", ("openclaw-gateway", "openclaw-vless", "auditd", "ssh.socket", "rsyslog")),
    ...
    RuntimeTarget(129, "lxc", "soc-analysis-01", "malware-analysis", ("clamav-daemon", "clamav-freshclam", "siem-static-analysis", "siem-security-sensor-forwarder@static-analysis")),
