...
FILE_MAPPINGS: tuple[FileMapping, ...] = (
    FileMapping(".github/workflows/deploy-homelab.yml", ".github/workflows/deploy-homelab.yml"),
    FileMapping(".github/workflows/validate-main.yml", ".github/workflows/validate-main.yml"),
    ...
    FileMapping("secret_runtime.py", "secret_runtime.py"),
    FileMapping("oidc_runtime.py", "oidc_runtime.py"),
    FileMapping("certification_runtime.py", "certification_runtime.py"),
    ...
    FileMapping("backup_runtime.py", "backup_runtime.py"),
    FileMapping("asset_catalog_runtime.py", "asset_catalog_runtime.py"),
    FileMapping("clickhouse_runtime.py", "clickhouse_runtime.py"),
    FileMapping("content_runtime.py", "content_runtime.py"),
    FileMapping("control_plane_health.py", "control_plane_health.py"),
    FileMapping("control_plane_access_ops.py", "control_plane_access_ops.py"),
    FileMapping("control_plane_case_ops.py", "control_plane_case_ops.py"),
    FileMapping("control_plane_connector_ops.py", "control_plane_connector_ops.py"),
    FileMapping("control_plane_content_ops.py", "control_plane_content_ops.py"),
    FileMapping("control_plane_response_ops.py", "control_plane_response_ops.py"),
    FileMapping("control_plane_governance_ops.py", "control_plane_governance_ops.py"),
    FileMapping("enterprise_control_plane_defaults.py", "enterprise_control_plane_defaults.py"),
    FileMapping("inventory_catalog.py", "inventory_catalog.py"),
    FileMapping("runtime_humanization.py", "runtime_humanization.py"),
    FileMapping("proxmox_guest_ops.py", "proxmox_guest_ops.py"),
    FileMapping("incident_ai_runtime.py", "incident_ai_runtime.py"),
    FileMapping("proxmox_fleet_runtime.py", "proxmox_fleet_runtime.py"),
    FileMapping("response_workflow_runtime.py", "response_workflow_runtime.py"),
    FileMapping("source_onboarding_runtime.py", "source_onboarding_runtime.py"),
    FileMapping("topology_runtime.py", "topology_runtime.py"),
    FileMapping("host_access_runtime.py", "host_access_runtime.py"),
    FileMapping("vuln_asset_binding.py", "vuln_asset_binding.py"),
    FileMapping("deps_platform_ops.py", "deps_platform_ops.py"),
    FileMapping("deps_runtime_docs_ops.py", "deps_runtime_docs_ops.py"),
    FileMapping("health_surfaces.py", "health_surfaces.py"),
    FileMapping("host_runtime_pipeline.py", "host_runtime_pipeline.py"),
    FileMapping("host_runtime_runtime.py", "host_runtime_runtime.py"),
    FileMapping("storage_ha_runtime.py", "storage_ha_runtime.py"),
    FileMapping("stream_state_runtime.py", "stream_state_runtime.py"),
    FileMapping("transport_health_runtime.py", "transport_health_runtime.py"),
    FileMapping("vulnerability_query_runtime.py", "vulnerability_query_runtime.py"),
    FileMapping("vuln_greenbone.py", "vuln_greenbone.py"),
    FileMapping("vuln_maturity_runtime.py", "vuln_maturity_runtime.py"),
    FileMapping("vuln_store.py", "vuln_store.py"),
    FileMapping("vuln_runtime.py", "vuln_runtime.py"),
    FileMapping("deps.py", "deps.py"),
    FileMapping("operational_filters.py", "operational_filters.py"),
    FileMapping("content_store.py", "content_store.py"),
    FileMapping("enterprise_control_plane.py", "enterprise_control_plane.py"),
    ...
    FileMapping("control_plane_governance_ops.py", "services/web/app/control_plane_governance_ops.py"),
    FileMapping("enterprise_control_plane_defaults.py", "services/web/app/enterprise_control_plane_defaults.py"),
    FileMapping("inventory_catalog.py", "services/web/app/inventory_catalog.py"),
    FileMapping("runtime_humanization.py", "services/web/app/runtime_humanization.py"),
    FileMapping("proxmox_guest_ops.py", "services/web/app/proxmox_guest_ops.py"),
    FileMapping("incident_ai_runtime.py", "services/web/app/incident_ai_runtime.py"),
    FileMapping("proxmox_fleet_runtime.py", "services/web/app/proxmox_fleet_runtime.py"),
    FileMapping("response_workflow_runtime.py", "services/web/app/response_workflow_runtime.py"),
    FileMapping("source_onboarding_runtime.py", "services/web/app/source_onboarding_runtime.py"),
    FileMapping("topology_runtime.py", "services/web/app/topology_runtime.py"),
    FileMapping("host_access_runtime.py", "services/web/app/host_access_runtime.py"),
    FileMapping("vuln_asset_binding.py", "services/web/app/vuln_asset_binding.py"),
    ...
    FileMapping("vuln_greenbone.py", "services/web/app/vuln_greenbone.py"),
    FileMapping("vuln_maturity_runtime.py", "services/web/app/vuln_maturity_runtime.py"),
    FileMapping("vuln_store.py", "services/web/app/vuln_store.py"),
    FileMapping("vuln_runtime.py", "services/web/app/vuln_runtime.py"),
    FileMapping("security.py", "services/web/app/security.py"),
    FileMapping("secret_runtime.py", "services/web/app/secret_runtime.py"),
    FileMapping("oidc_runtime.py", "services/web/app/oidc_runtime.py"),
    FileMapping("certification_runtime.py", "services/web/app/certification_runtime.py"),
    ...
    FileMapping("console_router_registry.py", "services/web/app/routes/console_router_registry.py"),
    ...
    FileMapping("events.py", "services/web/app/routes/events.py"),
    ...
    FileMapping("source_discovery.py", "source_discovery.py"),
    ...
    FileMapping("docs/credentials_registry.md", "docs/credentials_registry.md"),
    ...
    FileMapping("deploy/github_actions_secret_seed.py", "deploy/github_actions_secret_seed.py"),
    ...
    FileMapping("sql_12_filter_rule_seed.sql", "sql_12_filter_rule_seed.sql"),
    FileMapping("sql_13_batch_corr_seed.sql", "sql_13_batch_corr_seed.sql"),
    FileMapping("sql_15_batch_corr_soc_seed.sql", "sql_15_batch_corr_soc_seed.sql"),
    ...
    FileMapping("asset_binding_overrides.py", "asset_binding_overrides.py"),
    FileMapping("correlation_pack_runtime.py", "correlation_pack_runtime.py"),
    FileMapping("control_plane_governance_runtime.py", "control_plane_governance_runtime.py"),
    FileMapping("keycloak_admin_runtime.py", "keycloak_admin_runtime.py"),
    FileMapping("asset_binding_overrides.py", "services/web/app/asset_binding_overrides.py"),
    FileMapping("correlation_pack_runtime.py", "services/web/app/correlation_pack_runtime.py"),
    FileMapping("control_plane_governance_runtime.py", "services/web/app/control_plane_governance_runtime.py"),
    FileMapping("keycloak_admin_runtime.py", "services/web/app/keycloak_admin_runtime.py"),
