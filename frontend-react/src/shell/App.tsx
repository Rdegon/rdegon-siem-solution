...
export function App() {
  ...
  const routeSectionMap: Record<string, string> = {
    ...
    "/security/ngfw": "sources",
    "/security/ips": "sources",
  ...
  const allNavItems = [
    ...
    { to: "/security/ngfw", label: "NGFW", icon: "access" as const },
    { to: "/security/ips", label: "IPS", icon: "incidents" as const },
    ...
    { to: "/security/vulnerability", label: t(uiLang, { en: "Vulnerability", ru: "Сканер уязвимостей" }), icon: "vuln" as const },
    { to: "/security/runtime", label: t(uiLang, { en: "Runtime", ru: "Защита контейнеров" }), icon: "dashboard" as const },
  ...
  const navGroupDefinitions = [
    ...
    },
    {
      ...
      routes: ["/security/ndr", "/security/ngfw", "/security/ips", "/security/dfir", "/security/analysis", "/security/vulnerability", "/security/runtime", "/security/threat-intel", "/security/pki", "/security/evidence"],
    },
    {
      id: "content",
