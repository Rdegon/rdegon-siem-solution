...
class ExportCleanProjectBundleTests(unittest.TestCase):
    def test_export_bundle_copies_project_and_writes_manifest(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("deploy.export_clean_project_bundle._tracked_files", return_value=["services/web/main.py", "docs/README.md", "deploy/sample.py"]):
            ...
            self.assertTrue((target_root / "project" / "services" / "web" / "main.py").exists())
